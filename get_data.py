...
os.environ["MLFLOW_REGISTRY_URI"] = "/home/user/project/mlflow/"
mlflow.set_tracking_uri("http://localhost:5000")
mlflow.set_experiment("get_data")

key = "AIzaSyBSDbRMT_lCF5xr-XSQtq-qUmQQnqP7ExA"
api = Api(api_key=key)
...
with mlflow.start_run():
    ...
    mlflow.log_artifact(local_path="/home/user/project/mlops_module_3/scripts/get_data.py",
                        artifact_path="get_data code")
    mlflow.end_run()
 
with open('/home/user/project/mlops_module_3/datasets/data.csv', 'a') as f:
    f.write("{}\n".format(s))
